  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    if (res) {
      ...
      toast({
        ...
        description: "Uh Oh! Some problem Occurred while deleting the Event.",
      });
    ...
    >
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Please note that this action is irreversible as the Event and its
            participants & id card will be permanently deleted from our servers.
          </AlertDialogDescription>
        </AlertDialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Type the Event name i.e. <code>"{project.name}"</code> to
                    confirm.
                  </FormLabel>
                  <FormControl>
